...
function ProviderButton({ icon, children, className, onClick }) {
  ...
  return (
    <button
      className={`
        flex justify-center items-center gap-2 px-3 py-2 border bg-white border-gray-400 
        rounded-lg transition-all duration-150 hover:bg-gray-200 hover:border-gray-400
        hover:shadow-sm hover:cursor-pointer active:scale-[0.98] active:bg-gray-300
