...
// E.g., if we started at our chatify directory to run "_scripts/node/deleteUser.js", to access deleteUser.json, we'd do "_test/deleteUser.json"
// E.g., if we started at our backend directory to run "../_scripts/node/deleteUser.js", to access deleteUser.json, we'd do "../_test/deleteUser.json"
